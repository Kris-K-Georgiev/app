export default function page() {
  return `
    <section class="max-w-2xl mx-auto mt-8">
      <h1 class="text-3xl font-bold mb-4">Welcome to PWA WebApp</h1>
      <p class="mb-4">This is a modern PWA built with vanilla JS, TailwindCSS, and Flowbite JS components. Use the navigation bar to explore the app.</p>
          ...
          <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-6 space-y-6">
              <p class="text-base leading-relaxed text-gray-500 dark:text-gray-400">
                This is a Flowbite JS modal component, fully functional without React.
              </p>
            </div>
